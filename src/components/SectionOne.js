            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
              <div class="box-wrap">
                ...
                <p class="mt-4">
                  ...
                  services. Our Bank card is the best option.
                </p>
              </div>
            </div>
          ...
          <div class="container py-lg-5 py-md-3">
            <div class="row">
              <div class="col-lg-7 mb-lg-0 mb-md-5 mb-4 align-self">
                <h3 class="title-left mx-0">
                  Our bank founded in 2015 to introduce the new level of
                  financial services. We are still dedicated to the success of
                  our clients.
                </h3>
                <p class="mt-md-4 mt-3">
                  ...
                  non velit, culpa! Vivamus a et ut justo, init in dolor et.
                </p>
                <a
              ...
              <div class="col-lg-5">
                <div class="position-relative">
                  <img src={about} alt="" class="radius-image img-fluid" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="container">
            ...
            <div class="row mobile-info-inn mx-lg-0">
              <div class="col-lg-4 mobile-right text-right">
                <div class="row mobile-right-grids mb-lg-5 mb-4">
                  <div class="col-10 mobile-right-info">
                    <h6>
                      <a href="#url">Mobile Banking Apps</a>
                    </h6>
                    <p>
                ...
                <div class="row mobile-right-grids">
                  <div class="col-10 mobile-right-info">
                    <h6>
                      <a href="#url">Various Locations </a>
                    </h6>
                    <p>
                      We have offices in many countries including the USA and
                      the UK.
                    </p>
                  </div>
                  <div class="col-2 mobile-right-icon">
              ...
              <div class="col-lg-4 mobile-left px-lg-5">
                <img src={mobile} class="img-fluid radius-image" alt="mobile" />
              </div>
              <div class="col-lg-4 mobile-right">
                <div class="row mobile-right-grids mb-lg-5 mb-4">
                  ...
                  <div class="col-10 mobile-right-info">
                    <h6>
                      <a href="#url">Personal Profile</a>
                    </h6>
                    <p>
                      Register your free personal profile online to begin using
                      our services.
                    </p>
                  </div>
                </div>
                <div class="row mobile-right-grids mb-lg-5 mb-4">
                  ...
                  <div class="col-10 mobile-right-info">
                    <h6>
                      <a href="#url">Easy Account Setup</a>
                    </h6>
                    <p>
                ...
                <div class="row mobile-right-grids">
                  ...
                  <div class="col-10 mobile-right-info">
                    <h6>
                      <a href="#url">24/7 support</a>
                    </h6>
                    <p>
                      Support team is always ready to help you solve any banking
                      issues
                    </p>
                  </div>
                </div>
          ...
          <div class="grids-area-hny main-cont-wthree-fea row pt-3">
            <div class="col-lg-3 ceo-text mb-lg-0 mb-4">
              <div class="">
                ...
                <p>
                  Vivamus a et ut justo, init in. Ut eurt leo non. Duis sed
                  dolor et amet. Sed blandit at mi vel set hendrerit. Sed nisl
                  justo, init id purus vitae, nibh sed et
                </p>
                <div class="author align-items-center mt-4 mb-1">
                  <div class="img-circle">
                    <img src={team2} class="mr-3 img-fluid" alt="..." />
                  </div>
                  <div class="author-info">
                    <a href="#author">Maxwell ker</a> <br />{" "}
                    <span class="meta-value">Sep 28, 2020 </span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 grids-feature mt-lg-0 mt-4">
              <div class="area-box">
                ...
                <p>
                  Vivamus a et ut justo, init in. Ut eu leo non. Duis sed dolor
                  et.
                </p>
              </div>
            </div>
          ...
          <div class="container py-lg-5 py-md-3 py-2">
            ...
            <div class="row">
              <div class="col-lg-4 align-self w3l-progressblock pr-lg-4">
                ...
                <div class="progress-info info1">
                  <h6 class="progress-tittle">
                    Financial consulting <span class="">80%</span>
                  </h6>
                  <div class="progress">
                    <div
                ...
                <div class="progress-info info2">
                  <h6 class="progress-tittle">
                    Online Bank cards <span class="">95%</span>
                  </h6>
                  <div class="progress">
                    <div
                      class="progress-bar progress-bar-striped"
                ...
                <div class="progress-info info3">
                  <h6 class="progress-tittle">
                    Online reporting <span class="">90%</span>
                  </h6>
                  <div class="progress">
                    <div
                      class="progress-bar progress-bar-striped"
                ...
                <div class="progress-info info4">
                  <h6 class="progress-tittle">
                    Online banking <span class="">75%</span>
                  </h6>
                  <div class="progress">
                    <div
                      class="progress-bar progress-bar-striped"
                ...
                <div class="progress-info info2 mb-0">
                  <h6 class="progress-tittle">
                    24/7 support <span class="">95%</span>
                  </h6>
                  <div class="progress">
                    <div
                      class="progress-bar progress-bar-striped"
              ...
              <div class="col-lg-4 col-md-6 mt-lg-0 mt-md-5 mt-4">
                <img src={stats} alt="" class="radius-image img-fluid" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="container py-lg-3">
          <div class="row align-items-center">
            ...
            <div class="col-lg-5 mt-lg-0 mt-4">
              <a class="btn btn-style btn-dark" href="#book">
                {" "}
                Book a card
              </a>
            </div>
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="work-grids">
                ...
                <div class="content">
                  ...
                  <p class="desc">
                    Lorem ipsum dolor sit amet, dolor set elit Ut leo non.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section id="grids5-block" class="py-5">
          <div class="container py-lg-5 py-md-4 py-2">
              ...
              <div class="col-lg-4 col-md-6">
                <div class="grids5-info">
                  ...
                  <div class="blog-info">
                    ...
                    <p class="date">
                      <span class="fa fa-calendar mr-2"></span> September 17,
                      2020
                    </p>
                    <p>
              ...
              <div class="col-lg-4 col-md-6 mt-lg-0 mt-5">
                <div class="grids5-info">
                  ...
                  <div class="blog-info">
                    <h4>
                      <a href="#blog-single">
                        How is it progressing and what will 2020 bring?
                      </a>
                    </h4>
                    <p class="date">
                      <span class="fa fa-calendar mr-2"></span> September 17,
            ...
            <div class="text-center">
              <a class="btn btn-style btn-primary mt-sm-5 mt-4" href="#blog">
                View all blog posts
              </a>
            </div>
          </div>
